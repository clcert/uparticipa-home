export default function BugQuest2025() {
            ...
            <section className="hero is-light" aria-labelledby="bug-bounty-title">
                <div className="hero-body pb-0 mt-4">
                    <div className="container">
                        <figure>
                            <img src="/images/bug-bounty-2025/banner.png" alt="Banner Bug Quest" style={{ maxHeight: '270px' }} />
                        </figure>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="columns">
                        ...
                        <aside className="column is-hidden-mobile">
                            <nav className="menu box" aria-label="Índice del concurso" style={{ position: 'sticky', top: '1.5rem' }}>
                                ...
                                <ul className="menu-list">
                                    ...
                                    <li><a href="#dates-title">Fechas del Concurso</a></li>
            ...
            <section className="section">
                <div className="container content">
                    <div className="box" role="region" aria-labelledby="summary-title">
                        ...
                        <ol>
                            <li><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/simple/vote" target="_blank"><b>Elección Simple</b></a></li>
                            <li><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/massive/vote" target="_blank"><b>Elección Masiva</b></a></li>
                            <li><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/exclusive/vote" target="_blank"><b>Elección con Opciones Excluyentes</b></a></li>
                        </ol>
                    ...
                    <div className="box" role="region" aria-labelledby="desc-title">
                        ...
                        <p>
                            El Concurso <span className="has-text-weight-bold">BugQuest UParticipa 2025</span> del proyecto <a href="https://uparticipa.cl" target="_blank">UParticipa</a> (de ahora
                            en adelante, “el concurso) es un concurso para
                            <span className="has-text-weight-bold"> encontrar y reportar
                                vulnerabilidades que puedan existir en la plataforma 
                                UParticipa</span>.
                            El concurso está abierto a todas las 
                        ...
                        <p>
                            ...
                            que potencialmente afectaría. En el concurso se premiarán las
                    ...
                    <div className="box" role="region" aria-labelledby="audience-title">
                        ...
                        <p>
                            El público objetivo del concurso son miembros de la comunidad de
                            la Universidad de Chile, en particular estudiantes,
                            académicos/as, funcionarios/as y alumni de la Casa de Bello. Por
                            la naturaleza del concurso, se espera que las personas participantes sean
                            personas con conocimientos en áreas como
                            Ciberseguridad, Hacking Ético y Criptografía Aplicada.
                        </p>
                        <p>
                            Para participar del concurso, y poder enviar un reporte, las personas
                    ...
                    <div className="box" role="region" aria-labelledby="deploy-title">
                        ...
                        <p>
                            El sistema de UParticipa tendrá un despliegue específico para este concurso,
                        ...
                        <div className="mt-4">
                            ...
                            <ol>
                                <li><b><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/simple/vote" target="_blank">Elección Simple</a></b></li>
                                <li><b><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/massive/vote" target="_blank">Elección Masiva</a></b></li>
                                <li><b><a href="https://bugquest2025.uparticipa.cl/psifos/api/app/exclusive/vote" target="_blank">Elección con Opciones Excluyentes</a></b></li>
                            </ol>
                            <p className="subtitle is-italic">NOTA: Se recomienda utilizar ventana privada o ventana incógnito para ingresar a votar.</p>
                        </div>
                    </div>
                        ...
                        <div className="">
                            <div className="mb-2">
                                <div className="notification is-info" role="note">
                                    <p><strong>INICIO:</strong> miércoles 29 de octubre de 2025</p>
                                    <p><strong>FIN:</strong> viernes 20 de marzo de 2026</p>
                                </div>
                            </div>
                            <div className="mt-2">
                                <div className="notification is-info" role="note">
                                    <strong>CHARLA DE LANZAMIENTO:</strong> jueves 30 de octubre de 2025
                                    <p><a href="https://youtu.be/s0hCtSdb7AQ" target="_blank">Ver video de charla de lanzamiento (YouTube) ⤴</a></p>
                                </div>
                            </div>
                            <div className="mt-2">
                                <div className="notification is-info" role="note">
                                    <strong>CEREMONIA DE PREMIACIÓN:</strong> miércoles 01 de
                                    abril de 2026 a las 12:00 h
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <p>
                            Se realizará una Ceremonia de Premiación el día miércoles 01 de
                            abril de 2026 en el Departamento de Ciencias de la Computación
                    ...
                    <div className="box" role="region" aria-labelledby="terms-title">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                el presente concurso (credenciales, nivel de autorización y tipo
                                de elecciones).
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <code style={{wordBreak: "break-word"}}>https://bugquest2025.uparticipa.cl/*</code>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <i>NOTA: el equipo de UParticipa maneja una lista interna de otras vulnerabilidades conocidas,
                                las cuales no se revelarán durante el concurso, debido a que espera que las/los hackers puedan
                                ...
                                dicha lista al momento de finalizar el concurso, y así transparentar la información
                    ...
                    >
                        ...
                        <p>
                            UParticipa agradece el patrocinio y apoyo de las siguientes entidades para la realización del Concurso Bug Quest UParticipa 2025:
                        </p>
                        <div className="columns">
                    ...
                    >
                        ...
                        <p>Para cualquier consulta u observación sobre el concurso, enviar un correo a: <code>participa [at] uchile [dot] cl</code></p>
                    </div>
